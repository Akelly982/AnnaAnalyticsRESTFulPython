...
Original file is located at
    https://colab.research.google.com/github/pytorch/tutorials/blob/gh-pages/_downloads/6c042f3d39855d2a2de414758e5f9836/flask_rest_api_tutorial.ipynb
"""
...
with open("/content/drive/MyDrive/Colab Notebooks/Rest/224RGB.png", 'rb') as f:
    image_bytes = f.read()
...
imagenet_class_index = json.load(open('/content/drive/MyDrive/Colab Notebooks/Rest/imagenet_class_index.json'))
